...
public static class AllApiEndpoints
{
    public static void MapCustomerEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/", async (MeterReaderApiContext db) =>
        {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<Customer>, NotFound>> (string id, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (string id, CustomerDto customer, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (Customer customer, MeterReaderApiContext db) =>
        {
        ...
        group.MapDelete("/{id}", async Task<Results<Ok, NotFound>> (string id, MeterReaderApiContext db) =>
        {
            var affected = await db.Customer
                .Where(model => model.CUSTNMBR == id)
                .ExecuteDeleteAsync();
    ...
    public static void MapDeviceEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<Device>, NotFound>> (int id, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, Device device, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (Device device, MeterReaderApiContext db) =>
        {
        ...
        group.MapDelete("/{id}", async Task<Results<Ok, NotFound>> (int id, MeterReaderApiContext db) =>
        {
            var affected = await db.Device
                .Where(model => model.Id == id)
                .ExecuteDeleteAsync();
    ...
    public static void MapMonthEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<Month>, NotFound>> (int id, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, Month month, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (Month month, MeterReaderApiContext db) =>
        {
            db.Month.Add(month);
            await db.SaveChangesAsync();
    ...
    public static void MapReadingExportEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<ReadingExport>, NotFound>> (int id, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, ReadingExport readingExport, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (ReadingExport readingExport, MeterReaderApiContext db) =>
        {
    ...
    public static void MapRM00303Endpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<RM00303>, NotFound>> (string id, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (string id, RM00303 rM00303, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (RM00303 rM00303, MeterReaderApiContext db) =>
        {
    ...
    public static void MapUserEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<User>, NotFound>> (int id, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, User user, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (User user, MeterReaderApiContext db) =>
        {
            db.User.Add(user);
            await db.SaveChangesAsync();
    ...
    public static void MapReadingEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        // GET /api/Reading?billingSite=SITE
        // Returns readings from the latest export.
        // ExceptionReading (from DB) drives IsAbnormalReading on each record —
        // no extra calculation at query time; the stored proc already stamped the flag.
        group.MapGet("/", async (string? billingSite, MeterReaderApiContext db) =>
        {
            // Always pull from the last export: SELECT TOP 1 WaterReadingExportID FROM [dbo].[BS_WaterReadingExportData] ORDER BY WaterReadingExportID DESC
            var exportId = await db.Reading
                                   .OrderByDescending(r => r.WaterReadingExportID)
                                   .Select(r => r.WaterReadingExportID)
                                   .FirstOrDefaultAsync();

            var readings = await db.Reading
                                   .Where(r => r.WaterReadingExportID == exportId
                                            && (r.IsCityTab == null || r.IsCityTab != true))
                                   .ToListAsync();
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (UpdateReadingDto reading, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("Image/{id}", async Task<Results<Ok, NotFound>> (ImageSyncDto reading, MeterReaderApiContext db) =>
        {
            var affected = await db.Reading
                .Where(model => model.WaterReadingExportDataID == reading.WaterReadingExportDataId)
                .ExecuteUpdateAsync(setters => setters
        ...
        group.MapPost("/", async (Reading reading, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/list", async (List<Reading> readings, MeterReaderApiContext db) =>
        {
    ...
    public static void MapBillingLocationEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<BillingLocation>, NotFound>> (int billinglocationid, MeterReaderApiContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int billinglocationid, BillingLocation billingLocation, MeterReaderApiContext db) =>
        {
        ...
        group.MapPost("/", async (BillingLocation billingLocation, MeterReaderApiContext db) =>
        {
        ...
        group.MapDelete("/{id}", async Task<Results<Ok, NotFound>> (int billinglocationid, MeterReaderApiContext db) =>
        {
            var affected = await db.BillingLocation
                .Where(model => model.BillingLocationID == billinglocationid)
                .ExecuteDeleteAsync();
    ...
    public static void MapLoginEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/", async (LoginDto loginDto, UserManager<IdentityUser> _userManager, MeterReaderApiContext db) =>
        {
